      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => openPanel('learningHub')} className="p-2 rounded-lg bg-theme-secondary hover:bg-theme-tertiary transition-all btn-press text-teal-600 dark:text-teal-400" aria-label="Learning Hub" title="Learning Hub">
